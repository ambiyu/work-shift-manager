	...
	public static void main(String[] args) {
		...
		for (String[] dayspec: OPENING_HOURS) {
			...
			for (int i = 0; i < SHIFT_HOURS.length-normal; i++) {
				scheduler.addShift(dayspec[0], SHIFT_HOURS[i][0], SHIFT_HOURS[i][1], "2");
		...
		report("Registered Employee:", scheduler.getRegisteredStaff());
		report("Unassigned Employee:", scheduler.getUnassignedStaff());
